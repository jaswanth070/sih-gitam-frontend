...
function TAFormPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TAFormPage.useEffect": ()=>{
            let mounted = true;
            const fillPdf = {
                "TAFormPage.useEffect.fillPdf": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        const resp = await fetch(TA_PDF_SRC);
                        if (!resp.ok) throw new Error(`Failed to fetch PDF: ${resp.status}`);
                        const sourceBuffer = await resp.arrayBuffer();
                        ...
                        // Sample beneficiary & bank details
                        const beneficiary = {
                            teamLeaderName: "Alex Johnson",
                            instituteName: "GITAM University",
                            aadharNumber: "1234 5678 9012",
                            panNumber: "ABCDE1234F",
                            beneficiaryAddress_1: "123 Innovation Street",
                            beneficiaryAddress_2: "Sector 5",
                            beneficiaryPin: "530045",
                            beneficiaryPhone: "+91 98765 43210",
                            beneficiaryEmail: "alex.johnson@example.com",
                            bankName: "State Bank of India",
                            branchName: "Beach Road Branch",
                            bankAddress_1: "45 Seaside Avenue",
                            bankAddress_2: "Near GITAM",
                            bankAddressPin: "530002",
                            bankPhone: "0891-1234567",
                            accountNumber: "456789123456",
                            ifscCode: "SBIN0001234",
                            accountInNameYes: "Yes",
                            accountInNameNo: "",
                            jointAccountYes: "",
                            jointAccountNo: "No",
                            accountOperationalYes: "Yes",
                            accountOperationalNo: ""
                        };
                        // fill beneficiary fields
                        Object.entries(beneficiary).forEach({
                            "TAFormPage.useEffect.fillPdf": ([k, v])=>{
                                try {
                                    form.getTextField(k).setText(v);
                                    return;
                                } catch (e) {}
                                try {
                                    form.getDropdown(k).select(v);
                                    return;
                                } catch (e) {}
                                try {
                                    const normalized = (v || "").toLowerCase();
                                    const cb = form.getCheckBox(k);
                                    if (normalized === "yes" || normalized === "true") cb.check();
                                    else if (normalized === "no" || normalized === "false") cb.uncheck();
                                } catch (e) {}
                            }
                        }["TAFormPage.useEffect.fillPdf"]);
                        // create sample members data and compute grand total of admissible fares
                        const members = [];
                        let grandTotal = 0;
                        const sampleNames = [
                            "Leader: Alex Johnson",
                        ...
                        MEMBER_INDICES.forEach({
                            "TAFormPage.useEffect.fillPdf": (idx, i)=>{
                                const onwardFare = (i + 1) * 200 // sample
                                ;
                                const returnFare = (i + 1) * 180;
                                const onwardAdmissible = (i + 1) * 150;
                                const returnAdmissible = (i + 1) * 130;
                                grandTotal += onwardAdmissible + returnAdmissible;
                                const day = 1 + i;
                                const onwardDate = `2025-12-${String(day).padStart(2, "0")}`;
                                const returnDate = `2025-12-${String(day + 1).padStart(2, "0")}`;
                                const data = {
                                    [`${idx}personName`]: sampleNames[i] || `Member ${i + 1}`,
                                    [`${idx}onwardFromDate`]: onwardDate,
                                    [`${idx}onwardFromTime`]: "08:30",
                                    [`${idx}onwardFromPlace`]: "Visakhapatnam",
                                    [`${idx}onwardToDate`]: onwardDate,
                                    [`${idx}onwardToTime`]: "12:30",
                                    [`${idx}onwardToPlace`]: "Vijayawada",
                                    [`${idx}onwardFare`]: String(onwardFare),
                                    [`${idx}onwardadmissibleFare`]: String(onwardAdmissible),
                                    [`${idx}returnFromDate`]: returnDate,
                                    [`${idx}returnFromTime`]: "18:45",
                                    [`${idx}returnFromPlace`]: "Vijayawada",
                                    [`${idx}returnToDate`]: returnDate,
                                    [`${idx}returnToTime`]: "22:00",
                                    [`${idx}returnToPlace`]: "Visakhapatnam",
                                    [`${idx}returnFare`]: String(returnFare),
                                    [`${idx}returnadmissibleFare`]: String(returnAdmissible),
                                    [`${idx}travelMode`]: "Train",
                                    [`${idx}sign`]: sampleNames[i] || `Member ${i + 1}`
                                };
                                members.push(data);
                            }
                        }["TAFormPage.useEffect.fillPdf"]);
                        // Fill member fields
                        members.forEach({
                            "TAFormPage.useEffect.fillPdf": (m)=>{
                        ...
                        // set grand total
                        try {
                            form.getTextField("grandTotal").setText(String(grandTotal));
                        } catch (e) {
                            try {
                                form.getDropdown("grandTotal").select(String(grandTotal));
                            } catch (e2) {}
                        }
                        ...
                        console.error(err);
                        setError("Prefill failed; showing original PDF");
                        setPdfUrl(null);
                    } finally{
                        setLoading(false);
                    }
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "The combined Mandate + TA form. Prefilled with sample values so you can verify field mapping."
                                }, void 0, false, {
                                    fileName: "[project]/app/poc/ta-form/page.tsx",
                                    lineNumber: 215,
                                    columnNumber: 13
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("iframe", {
                                    ref: iframeRef,
                                    src: pdfUrl ?? TA_PDF_SRC,
                                    title: "TA Students - Mandate Form",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Tip: The inline viewer lets you inspect and edit fields. Use the Open in new tab button to download a filled copy."
                        }, void 0, false, {
                            fileName: "[project]/app/poc/ta-form/page.tsx",
                            lineNumber: 251,
                            columnNumber: 11
...
_s(TAFormPage, "/5UfS996tyYSwQuga3JZC61tvU8=");
_c = TAFormPage;
var _c;
...
//# sourceMappingURL=_8c53af1a._.js.map