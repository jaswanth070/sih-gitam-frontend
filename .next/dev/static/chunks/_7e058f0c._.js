        ...
        "DocumentSubmissionPage.useEffect": ()=>{
            ...
            const fetchTeam = {
                "DocumentSubmissionPage.useEffect.fetchTeam": async ()=>{
                    ...
                    setError(null);
                    try {
                        const details = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getPOCTeamDetail(teamId);
                        if (isMounted) {
                            setTeam(details);
                        }
                    } catch (err) {
...
_s(DocumentSubmissionPage, "WXEKFOQ3ITWSKJWOfhps5NvxB7I=", false, function() {
    return [
...
//# sourceMappingURL=_7e058f0c._.js.map