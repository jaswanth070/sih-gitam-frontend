...
function POCTeamDetailsPage() {
    ...
    const matchesTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POCTeamDetailsPage.useCallback[matchesTeam]": (candidate)=>{
            if (candidate === undefined || candidate === null) return false;
            const value = String(candidate);
            return teamIdentifiers.some({
                "POCTeamDetailsPage.useCallback[matchesTeam]": (id)=>id === value
            }["POCTeamDetailsPage.useCallback[matchesTeam]"]);
        }
    }["POCTeamDetailsPage.useCallback[matchesTeam]"], [
        teamIdentifiers
    ]);
    const handleWsEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POCTeamDetailsPage.useCallback[handleWsEvent]": (message)=>{
            setRequests({
                "POCTeamDetailsPage.useCallback[handleWsEvent]": (prev)=>{
                    if ((message.event === "request_created" || message.event === "request_updated") && message.request) {
                        const incoming = message.request;
                        if (!matchesTeam(incoming.team_id)) return prev;
                        const merged = [
                            ...prev.filter({
                                "POCTeamDetailsPage.useCallback[handleWsEvent]": (existing)=>existing.id !== incoming.id
                            }["POCTeamDetailsPage.useCallback[handleWsEvent]"]),
                            incoming
                        ];
                        return merged.sort({
                            "POCTeamDetailsPage.useCallback[handleWsEvent]": (a, b)=>new Date(a.created_at).getTime() - new Date(b.created_at).getTime()
                        }["POCTeamDetailsPage.useCallback[handleWsEvent]"]);
                    }
                    if (message.event === "state_transition" && message.request_id && message.to) {
                        const updated = prev.map({
                            "POCTeamDetailsPage.useCallback[handleWsEvent].updated": (existing)=>existing.id === message.request_id ? {
                                    ...existing,
                                    status: message.to
                                } : existing
                        }["POCTeamDetailsPage.useCallback[handleWsEvent].updated"]);
                        return updated.sort({
                            "POCTeamDetailsPage.useCallback[handleWsEvent]": (a, b)=>new Date(a.created_at).getTime() - new Date(b.created_at).getTime()
                        }["POCTeamDetailsPage.useCallback[handleWsEvent]"]);
                    }
    ...
    const handleStatusChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POCTeamDetailsPage.useCallback[handleStatusChange]": async (requestId, newStatus)=>{
            try {
                const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["requestsService"].changeRequestStatus(requestId, newStatus);
                setRequests({
...
_s(POCTeamDetailsPage, "I2zvWl4emKnwXZOVhKW5u71YwJk=", false, function() {
    return [
...
_c3 = ActionLink;
function TeamRequestCard({ request, onStatusChange, timestampFormatter }) {
...
//# sourceMappingURL=_a0265c61._.js.map