...
async function prepareUpload(teamId, file, documentType) {
    ...
    const response = await fetch(buildUrl(`/api/documents/${teamId}/prepare-upload/`), {
        method: "POST",
...
async function notifyUploaded(versionId) {
    ...
    const response = await fetch(buildUrl(`/api/documents/notify-uploaded/${versionId}/`), {
        method: "POST",
...
async function approveDocument(versionId) {
    ...
    const response = await fetch(buildUrl(`/api/documents/approve/${versionId}/`), {
        method: "POST",
        headers: requireAuthHeaders()
    });
    if (!response.ok) {
...
async function rejectDocument(versionId) {
    ...
    const response = await fetch(buildUrl(`/api/documents/reject/${versionId}/`), {
        method: "POST",
        headers: requireAuthHeaders()
    });
    if (!response.ok) {
...
async function getDownloadURL(versionId) {
    ...
    const response = await fetch(buildUrl(`/api/documents/download/${versionId}/`), {
        method: "GET",
        headers: requireAuthHeaders()
    });
    if (!response.ok) {
...
async function listDocumentVersions(params) {
    const response = await fetch(buildUrl(`/api/documents/admin/versions/${buildQueryString(params)}`), {
        method: "GET",
        headers: requireAuthHeaders()
    });
    if (!response.ok) {
...
//# sourceMappingURL=_2351d4ee._.js.map