...
function POCTeamDetailsPage() {
    ...
    const matchesTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((candidate)=>{
        if (candidate === undefined || candidate === null) return false;
        const value = String(candidate);
        return teamIdentifiers.some((id)=>id === value);
    }, [
        teamIdentifiers
    ]);
    const handleWsEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((message)=>{
        setRequests((prev)=>{
            if ((message.event === "request_created" || message.event === "request_updated") && message.request) {
                ...
                const merged = [
                    ...prev.filter((existing)=>existing.id !== incoming.id),
                    incoming
                ];
                return merged.sort((a, b)=>new Date(a.created_at).getTime() - new Date(b.created_at).getTime());
            }
            if (message.event === "state_transition" && message.request_id && message.to) {
                const updated = prev.map((existing)=>existing.id === message.request_id ? {
                        ...existing,
                        status: message.to
                    } : existing);
    ...
    const handleStatusChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (requestId, newStatus)=>{
        try {
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["requestsService"].changeRequestStatus(requestId, newStatus);
...
//# sourceMappingURL=_6862a7f7._.js.map